...
oc apply -f https://github.com/bbrowning/crc-operator/releases/download/v0.4.1/release-v0.4.1_crd.yaml
```
...
oc apply -f https://github.com/bbrowning/crc-operator/releases/download/v0.4.1/release-v0.4.1.yaml
```
