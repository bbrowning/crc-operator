...
```
oc apply -f https://github.com/bbrowning/crc-operator/releases/download/v0.2.0/release-v0.2.0_crd.yaml
```
...
oc apply -f https://github.com/bbrowning/crc-operator/releases/download/v0.2.0/release-v0.2.0.yaml
```
