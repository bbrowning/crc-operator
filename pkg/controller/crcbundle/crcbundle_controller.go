...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner CrcBundle
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &crcv1alpha1.CrcBundle{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileCrcBundle) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &crcv1alpha1.CrcBundle{}
	...
	// Set CrcBundle instance as the owner and controller
...
func newPodForCR(cr *crcv1alpha1.CrcBundle) *corev1.Pod {
